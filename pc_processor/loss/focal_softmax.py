...
class FocalSoftmaxLoss_Point(nn.Module):
    def __init__(self, n_classes, gamma=1, alpha=0.8, softmax=True,ignore=None):
        super(FocalSoftmaxLoss_Point, self).__init__()
        self.gamma = gamma
        self.n_classes = n_classes
        self.ignore = ignore
